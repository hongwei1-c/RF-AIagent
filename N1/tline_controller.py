...
sys.path.insert(0, r"T:\py_prj\AIHFSS")
...
class TLineController:
    ...
    def __init__(self, work_dir: str = None,
        ...
        if work_dir is None:
            work_dir = "T:/TLine_AI_Runs"
        self.work_dir = Path(work_dir)
        self.work_dir.mkdir(parents=True, exist_ok=True)

        self.template_project = template_project or r"T:\AnsysPrj\TLine_stdr_ai.aedt"
